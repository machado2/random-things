...
export function bufferGeometryToIndexed(nonIndexedGeometry, fullIndex, precision) {
	...
	indexBufferGeometry(nonIndexedGeometry, geometry, fullIndex === undefined ? true : fullIndex);
